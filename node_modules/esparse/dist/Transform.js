...
class Transform {
    ...
    for (let i = 0; i < props.length; ++i) {
      ...
      switch (prop.type) {
        case 'PropertyDefinition':
          prop = new AST.PatternProperty(prop.name, prop.expression, null, prop.start, prop.end);
          break;
  ...
  transformIdentifier(node) {
    ...
    if ((0, _Scanner.isReservedWord)(value)) this.fail('Unexpected token ' + value, node);
